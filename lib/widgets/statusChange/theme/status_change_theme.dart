...
class StatusChangeTheme extends StatelessWidget {
  ...
  static final StatusChangeThemeData _kFallbackTheme = StatusChangeThemeData.fallback();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<StatusChangeThemeData>('data', data, showName: false));
  }
}
...
class _InheritedTheme extends InheritedTheme {
  ...
  Widget wrap(BuildContext context, Widget child) {
    ...
    return identical(this, ancestorTheme) ? child : StatusChangeTheme(data: theme.data, child: child);
  }
...
class StatusChangeThemeData with Diagnosticable {
  ...
  bool operator ==(Object other) {
    ...
    return other is StatusChangeThemeData && other.direction == direction && other.indicatorTheme == indicatorTheme && other.connectorTheme == connectorTheme;
  }
