...
import 'package:thewarehouse/widgets/statusChange/component/connect_indicator.dart';
...
class TimelineNode extends StatelessWidget with StatusChangeTileNode {
  ...
  double _getEffectiveIndicatorPosition(BuildContext context) {
    ...
    indicatorPosition ??= (indicator is PositionedIndicator) ? (indicator as PositionedIndicator).getEffectivePosition(context) : .5;
