...
import 'package:thewarehouse/widgets/statusChange/component/status_change_node.dart';
import 'package:thewarehouse/widgets/statusChange/component/status_change_tile.dart';
...
class StatusChangeTileBuilder {
  ...
  factory StatusChangeTileBuilder({
    ...
    final effectiveContentsBuilder = contentsBuilder == null
        ? null
    ...
    return StatusChangeTileBuilder._(
      (context, index) {
        final tile = StatusChangeTile(
          ...
          contents: effectiveContentsBuilder == null ? null : effectiveContentsBuilder(context, index),
